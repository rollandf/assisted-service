...
func Manifests() map[string]string {
	...
	manifests["99_openshift-localvolumeset_crd.yaml"] = localVolumeSetCrd
	manifests["99_openshift-clusterCrd.yaml"] = clusterCrd
	manifests["99_openshift-localvolume_crd.yaml"] = localVolumeSet
	manifests["99_openshift-localstorage_ns.yaml"] = localStorageNamespace
	manifests["99_openshift-localstorage_operator_group.yaml"] = lsoOperatorGroup
	manifests["99_openshift-ocs_ns.yaml"] = ocsNamespace
	manifests["99_openshift-ocs_catalog_source.yaml"] = ocsCatalogSource
	manifests["99_openshift-lso_catalog_source.yaml"] = lsoCatalogSource
	...
	manifests["99_openshift-lso_subscription.yaml"] = lsoSubscription
	manifests["99_openshift-lso_image_content_source_policy.yaml"] = lsoImageContentSourcePolicy
	manifests["99_openshift-ocs_storage_cluster.yaml"] = storageCluster
	return manifests
}

const lsoImageContentSourcePolicy = `apiVersion: operator.openshift.io/v1alpha1
...
const clusterCrd = `apiVersion: apiextensions.k8s.io/v1beta1
...
const storageCluster = `apiVersion: ocs.openshift.io/v1
kind: StorageCluster
metadata:
...
const lsoCatalogSource = `apiVersion: operators.coreos.com/v1alpha1
kind: CatalogSource
metadata:
...
const ocsCatalogSource = `apiVersion: operators.coreos.com/v1alpha1
kind: CatalogSource
metadata:
...
spec:
  ...
  image: quay.io/ocs-dev/ocs-registry:4.6.0
  publisher: Red Hat
  sourceType: grpc`
